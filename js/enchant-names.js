// Complete enchant-id -> TBC name map, generated from the Anniversary client's
// SpellItemEnchantment table (wago.tools build 2.5.5.67852) by
// pug-vetter/scripts/_gen_enchant_names.py.
//
// WCL reports the correct permanentEnchant ID but a retail-mangled NAME
// (squished magnitudes, renamed/nonexistent stats). This is the authoritative
// in-game tooltip text for every enchant, so analyze.js prefers it over WCL's.
